<html>
    ...
    <body>
                <h1>
            <center><font color="Red">Stationary</font></center>
        </h1>
    <?php
...
WHERE `category` = 'stationary'";
  ...
  $re=mysql_query($query1, $db);
    ...
    <label style="font-family: comic sans ms;"><br/>
                   ...
                   <label style="font-family: comic sans ms;"><b><font color="red">price:</b></label><label><blink><?=$rows['3']?></blink></label></font><a href="<?=$rows[6]?>" target="_blank"><img src="<?=$rows[6]?>" width="125" align="right" height="150" alt=""/><br/></a>
         ...
         <center><a href="sc.php?p_name=<?=$rows[3]?>" target="_parent"><img src="buy.png"></a></center>
     </fieldset>
    <?php
}
            ?>
