...
$Comp=$_GET['Company'];
   mysql_select_db("ostore",$db);
           $query1="SELECT * FROM `products` where Type='$type' and Company='$Comp'";
...
{
	echo"<a href=details.php?p_id=".$rows['0']."><div class=bg><img src=projectfiles/".$rows['6']." width=100 height=150 alt=noimage><p class=price>Price : ".$rows['4']."</p></div></a>";
}
print"</div>";
print"</tr></table>";
